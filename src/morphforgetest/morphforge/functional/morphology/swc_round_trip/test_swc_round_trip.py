...
class TestSWCRoundTrip(object):
    ...
    def test1(self):
        ...
        print "*", StripCommentsAndBlankLines(swcSrc), "*"
        print "*", StripCommentsAndBlankLines(swcOut), "*"
        assert StripCommentsAndBlankLines(swcSrc) == StripCommentsAndBlankLines(swcOut)
