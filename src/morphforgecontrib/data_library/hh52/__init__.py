...
ChannelLibrary.registerChannel(modelsrc=StandardModels.HH52,  channeltype="Na", chlFunctor=get_sample_na)
ChannelLibrary.registerChannel(modelsrc=StandardModels.HH52,  channeltype="K",  chlFunctor=get_sample_k)
ChannelLibrary.registerChannel(modelsrc=StandardModels.HH52,  channeltype="Lk", chlFunctor=get_sample_lk)
