...
lint: force_look
	pylint -E --output-format=html --include-ids=y --disable='C0301,C0111,W0142,R0904,R0903,C0103,W0404,R0914,R0902,R0913'  --max-args=7 src/morphforge/ > pylint_out.html
